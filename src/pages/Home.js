    ...
    <div className="container-fluid" id="main">
      ...
      <div className="row">
        ...
        <div className="col-md-4 offset-md-0">
            ...
            <h3>2016 - 2017 </h3>
            <br/>
            <p className="link"><a className="git" href="http://www.cahaber.me/SUYI" target="_blank">Exploring Academic Outcomes 📓</a></p>
            <br/>


            <p className="link"><a className="git react" href="/ZillowRenderDemo" target="_blank">Housing Render Demo 🎨</a></p>
            <br/>

            <p className="link"><a className="git react" title="Simple React transitioning, filter and search" href="/Reactd3" target="_blank">Simple ReactD3 Demo 🎨</a></p>
            <br/>

            <p className="link"><a className="git" href="/draw" target="_blank">SVG Draw! 🎨</a></p>
            <br/>

            <p className="link"><a className="git" href="/ReactAnimate" target="_blank">React Animations 🎨</a></p>
            <br/>

            <p className="link"><a className="git react" href="/GitReact" target="_blank">Github Fetch 🎨</a></p>
            <br/>
                       
            <p className="link"><a className="git" href="/project-docs/TranquilityTracker/" target="_blank">Tranquility Tracker 📓</a></p>
            <br/>
